...
// Object type
typedef struct gkyl_dg_calc_gr_vars gkyl_dg_calc_gr_vars;
 ...
 * @param vel_basis  Phase configuration and (four-velocity)-space basis functions
 ...
 * @param gr_pressure Output pressure
 */
...
/**
 * Delete pointer to updater to compute gr variables.
 *
 * @param up Updater to delete.
 */
void gkyl_dg_calc_gr_vars_release(struct gkyl_dg_calc_gr_vars *up);
...
void gkyl_dg_calc_gr_vars_pressure_cu(struct gkyl_dg_calc_gr_vars *up, 
  const struct gkyl_range *conf_range, const struct gkyl_range *phase_range,
  const struct gkyl_array* h_ij_inv,
  const struct gkyl_array* u_i, const struct gkyl_array* u_i_sq, 
  const struct gkyl_array* GammaV, const struct gkyl_array* GammaV_sq, 
