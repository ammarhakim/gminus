...
{ 
  ...
  temp[0] = Hxx[2]*V_0[2]*wx1+Hxx[1]*V_0[1]*wx1+Hxx[0]*V_0[0]*wx1; 
  temp[1] = 0.8944271909999159*Hxx[1]*V_0[2]*wx1+0.8944271909999159*V_0[1]*Hxx[2]*wx1+Hxx[0]*V_0[1]*wx1+V_0[0]*Hxx[1]*wx1; 
  temp[2] = 0.2886751345948129*Hxx[2]*V_0[2]*dv1+0.2886751345948129*Hxx[1]*V_0[1]*dv1+0.2886751345948129*Hxx[0]*V_0[0]*dv1; 
  temp[3] = 0.2581988897471612*Hxx[1]*V_0[2]*dv1+0.2581988897471612*V_0[1]*Hxx[2]*dv1+0.2886751345948129*Hxx[0]*V_0[1]*dv1+0.2886751345948129*V_0[0]*Hxx[1]*dv1; 
  temp[4] = 0.6388765649999399*Hxx[2]*V_0[2]*wx1+Hxx[0]*V_0[2]*wx1+V_0[0]*Hxx[2]*wx1+0.8944271909999159*Hxx[1]*V_0[1]*wx1; 
  temp[6] = 0.1844277783908294*Hxx[2]*V_0[2]*dv1+0.2886751345948129*Hxx[0]*V_0[2]*dv1+0.2886751345948129*V_0[0]*Hxx[2]*dv1+0.2581988897471611*Hxx[1]*V_0[1]*dv1; 

  temp_sq[0] = Hxx_sq[2]*V_0_sq[2]*wx1_sq+Hxx_sq[1]*V_0_sq[1]*wx1_sq+Hxx_sq[0]*V_0_sq[0]*wx1_sq+0.08333333333333333*Hxx_sq[2]*V_0_sq[2]*dv1_sq+0.08333333333333333*Hxx_sq[1]*V_0_sq[1]*dv1_sq+0.08333333333333333*Hxx_sq[0]*V_0_sq[0]*dv1_sq; 
  temp_sq[1] = 0.8944271909999159*Hxx_sq[1]*V_0_sq[2]*wx1_sq+0.8944271909999159*V_0_sq[1]*Hxx_sq[2]*wx1_sq+Hxx_sq[0]*V_0_sq[1]*wx1_sq+V_0_sq[0]*Hxx_sq[1]*wx1_sq+0.07453559924999298*Hxx_sq[1]*V_0_sq[2]*dv1_sq+0.07453559924999298*V_0_sq[1]*Hxx_sq[2]*dv1_sq+0.08333333333333333*Hxx_sq[0]*V_0_sq[1]*dv1_sq+0.08333333333333333*V_0_sq[0]*Hxx_sq[1]*dv1_sq; 
  temp_sq[2] = 0.5773502691896258*Hxx_sq[2]*V_0_sq[2]*dv1*wx1+0.5773502691896258*Hxx_sq[1]*V_0_sq[1]*dv1*wx1+0.5773502691896258*Hxx_sq[0]*V_0_sq[0]*dv1*wx1; 
  temp_sq[3] = 0.5163977794943223*Hxx_sq[1]*V_0_sq[2]*dv1*wx1+0.5163977794943223*V_0_sq[1]*Hxx_sq[2]*dv1*wx1+0.5773502691896258*Hxx_sq[0]*V_0_sq[1]*dv1*wx1+0.5773502691896258*V_0_sq[0]*Hxx_sq[1]*dv1*wx1; 
  ...
  temp_sq[5] = 0.07453559924999298*Hxx_sq[2]*V_0_sq[2]*dv1_sq+0.07453559924999298*Hxx_sq[1]*V_0_sq[1]*dv1_sq+0.07453559924999298*Hxx_sq[0]*V_0_sq[0]*dv1_sq; 
  temp_sq[6] = 0.3688555567816588*Hxx_sq[2]*V_0_sq[2]*dv1*wx1+0.5773502691896257*Hxx_sq[0]*V_0_sq[2]*dv1*wx1+0.5773502691896257*V_0_sq[0]*Hxx_sq[2]*dv1*wx1+0.5163977794943222*Hxx_sq[1]*V_0_sq[1]*dv1*wx1; 
  temp_sq[7] = 0.06666666666666667*Hxx_sq[1]*V_0_sq[2]*dv1_sq+0.06666666666666667*V_0_sq[1]*Hxx_sq[2]*dv1_sq+0.07453559924999302*Hxx_sq[0]*V_0_sq[1]*dv1_sq+0.07453559924999302*V_0_sq[0]*Hxx_sq[1]*dv1_sq; 
