...
{ 
  ...
  gkyl_mat_set(&rhs2,3,0,M12[3]); 
  gkyl_mat_set(&rhs2,4,0,M12[4]); 
  gkyl_mat_set(&rhs2,5,0,M12[5]); 
  gkyl_mat_set(&rhs2,6,0,M12[6]); 
  gkyl_mat_set(&rhs2,7,0,M12[7]); 
  gkyl_mat_set(&A2,0,0,0.5*M0[0]); 
  gkyl_mat_set(&A2,0,1,0.5*M0[1]); 
  gkyl_mat_set(&A2,0,2,0.5*M0[2]); 
  gkyl_mat_set(&A2,0,3,0.5*M0[3]); 
  gkyl_mat_set(&A2,0,4,0.5*M0[4]); 
  gkyl_mat_set(&A2,0,5,0.5*M0[5]); 
  gkyl_mat_set(&A2,0,6,0.5*M0[6]); 
  gkyl_mat_set(&A2,0,7,0.5*M0[7]); 
  gkyl_mat_set(&A2,1,0,0.5*M0[1]); 
  gkyl_mat_set(&A2,1,1,0.4472135954999579*M0[4]+0.5*M0[0]); 
  gkyl_mat_set(&A2,1,2,0.5*M0[3]); 
  gkyl_mat_set(&A2,1,3,0.447213595499958*M0[6]+0.5*M0[2]); 
  gkyl_mat_set(&A2,1,4,0.4472135954999579*M0[1]); 
  gkyl_mat_set(&A2,1,5,0.5000000000000001*M0[7]); 
  gkyl_mat_set(&A2,1,6,0.447213595499958*M0[3]); 
  gkyl_mat_set(&A2,1,7,0.5000000000000001*M0[5]); 
  gkyl_mat_set(&A2,2,0,0.5*M0[2]); 
  gkyl_mat_set(&A2,2,1,0.5*M0[3]); 
  gkyl_mat_set(&A2,2,2,0.4472135954999579*M0[5]+0.5*M0[0]); 
  gkyl_mat_set(&A2,2,3,0.447213595499958*M0[7]+0.5*M0[1]); 
  gkyl_mat_set(&A2,2,4,0.5000000000000001*M0[6]); 
  gkyl_mat_set(&A2,2,5,0.4472135954999579*M0[2]); 
  gkyl_mat_set(&A2,2,6,0.5000000000000001*M0[4]); 
  gkyl_mat_set(&A2,2,7,0.447213595499958*M0[3]); 
  gkyl_mat_set(&A2,3,0,0.5*M0[3]); 
  gkyl_mat_set(&A2,3,1,0.447213595499958*M0[6]+0.5*M0[2]); 
  gkyl_mat_set(&A2,3,2,0.447213595499958*M0[7]+0.5*M0[1]); 
  gkyl_mat_set(&A2,3,3,0.4472135954999579*M0[5]+0.4472135954999579*M0[4]+0.5*M0[0]); 
  gkyl_mat_set(&A2,3,4,0.4472135954999579*M0[3]); 
  gkyl_mat_set(&A2,3,5,0.4472135954999579*M0[3]); 
  gkyl_mat_set(&A2,3,6,0.4*M0[7]+0.447213595499958*M0[1]); 
  gkyl_mat_set(&A2,3,7,0.4*M0[6]+0.447213595499958*M0[2]); 
  gkyl_mat_set(&A2,4,0,0.5*M0[4]); 
  gkyl_mat_set(&A2,4,1,0.4472135954999579*M0[1]); 
  gkyl_mat_set(&A2,4,2,0.5000000000000001*M0[6]); 
  gkyl_mat_set(&A2,4,3,0.4472135954999579*M0[3]); 
  gkyl_mat_set(&A2,4,4,0.31943828249997*M0[4]+0.5*M0[0]); 
  gkyl_mat_set(&A2,4,5,0.0); 
  gkyl_mat_set(&A2,4,6,0.31943828249997*M0[6]+0.5000000000000001*M0[2]); 
  gkyl_mat_set(&A2,4,7,0.4472135954999579*M0[7]); 
  gkyl_mat_set(&A2,5,0,0.5*M0[5]); 
  gkyl_mat_set(&A2,5,1,0.5000000000000001*M0[7]); 
  gkyl_mat_set(&A2,5,2,0.4472135954999579*M0[2]); 
  gkyl_mat_set(&A2,5,3,0.4472135954999579*M0[3]); 
  gkyl_mat_set(&A2,5,4,0.0); 
  gkyl_mat_set(&A2,5,5,0.31943828249997*M0[5]+0.5*M0[0]); 
  gkyl_mat_set(&A2,5,6,0.4472135954999579*M0[6]); 
  gkyl_mat_set(&A2,5,7,0.31943828249997*M0[7]+0.5000000000000001*M0[1]); 
  gkyl_mat_set(&A2,6,0,0.5*M0[6]); 
  gkyl_mat_set(&A2,6,1,0.447213595499958*M0[3]); 
  gkyl_mat_set(&A2,6,2,0.5000000000000001*M0[4]); 
  gkyl_mat_set(&A2,6,3,0.4*M0[7]+0.447213595499958*M0[1]); 
  gkyl_mat_set(&A2,6,4,0.31943828249997*M0[6]+0.5000000000000001*M0[2]); 
  gkyl_mat_set(&A2,6,5,0.4472135954999579*M0[6]); 
  gkyl_mat_set(&A2,6,6,0.4472135954999579*M0[5]+0.31943828249997*M0[4]+0.5*M0[0]); 
  gkyl_mat_set(&A2,6,7,0.4*M0[3]); 
  gkyl_mat_set(&A2,7,0,0.5*M0[7]); 
  gkyl_mat_set(&A2,7,1,0.5000000000000001*M0[5]); 
  gkyl_mat_set(&A2,7,2,0.447213595499958*M0[3]); 
  gkyl_mat_set(&A2,7,3,0.4*M0[6]+0.447213595499958*M0[2]); 
  gkyl_mat_set(&A2,7,4,0.4472135954999579*M0[7]); 
  gkyl_mat_set(&A2,7,5,0.31943828249997*M0[7]+0.5000000000000001*M0[1]); 
  gkyl_mat_set(&A2,7,6,0.4*M0[3]); 
  gkyl_mat_set(&A2,7,7,0.31943828249997*M0[5]+0.4472135954999579*M0[4]+0.5*M0[0]); 
