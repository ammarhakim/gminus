...
GKYL_CU_DH void gr_vars_n_copy_1x3v_ser_p1(int count, const double *h_ij, struct gkyl_nmat *x, const double *M0, double* GKYL_RESTRICT n) 
{ 
  ...
  double V_sq[2] = {0.0}; 
  canonical_pb_vars_util_1x3v_ser_p1(h_ij, V, V, V_sq); 
