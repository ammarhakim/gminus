...
GKYL_CU_DH void gr_vars_n_copy_1x1v_ser_p2(int count, const double *h_ij, struct gkyl_nmat *x, const double *M0, double* GKYL_RESTRICT n) 
{ 
  ...
  double V_sq[3] = {0.0}; 
  canonical_pb_vars_util_1x1v_ser_p2(h_ij, V, V, V_sq); 
